...
Range \- [https://www.range.co/](https://www.range.co/)  
AI Usage \- AI assisted check-in prompts

Standuply \- [https://standuply.com/](https://standuply.com/)  
AI Usage \- AI team analysis, shows patterns, LLM powered automation for Agile tasks with AI-generated Agile charts

Gitmore \- [https://gitmore.io/](https://gitmore.io/)  
AI Usage \- AI summarized commits and PRs delivered straight to Slack or email, AI-generated stand up report, AI chat assistant, AI agent categorizes work into reports

Stepsize AI \- [https://stepsize.com/](https://stepsize.com/)  
AI Usage \- AI-generated weekly sprint and project reports with an issue tracker, AI commentary on metrics, AI risk detection, AI-driven daily standup summaries monitoring activities over Github, Slack

ClickUp Brain \- [https://clickup.com/](https://clickup.com/)  
AI Usage \- This is a knowledge manager and status generator in one. You can ask it “What is the situation of my team?” and it will look at every task, comment, and subtask to generate a report.

Motion \- [https://www.usemotion.com/features/ai-calendar](https://www.usemotion.com/features/ai-calendar)  
AI Usage \- Motion is an AI-driven calendar and task manager that acts like a personal assistant for the whole team. It automatically rebuilds everyone's schedule based on priority.

Spinach \- [http://Spinach.ai](http://Spinach.ai)  
...
TicNote Cloud \- [https://ticnote.com/en/home](https://ticnote.com/en/home)  
AI Usage \- this is a meeting-centered workspace that creates a shared memory for the team. It captures decisions made in calls and organizes them by project. If a team member is out and someone needs to cover for them, the covering member can ask the TicNote bot. It provides cited answers from your own team's history as well.